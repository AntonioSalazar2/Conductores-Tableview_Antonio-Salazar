...
public class MainApp extends Application {
    ...
    private ObservableList<DriverResult> data = FXCollections.observableArrayList();
    ...
    public void start(Stage primaryStage) {
        ...
        TableColumn<DriverResult, String> driverNameCol = new TableColumn<>("Driver Name");
        driverNameCol.setCellValueFactory(new PropertyValueFactory<>("driverName"));

        TableColumn<DriverResult, Integer> winsCol = new TableColumn<>("Wins");
        winsCol.setCellValueFactory(new PropertyValueFactory<>("wins"));

        TableColumn<DriverResult, Integer> totalPointsCol = new TableColumn<>("Total Points");
        totalPointsCol.setCellValueFactory(new PropertyValueFactory<>("totalPoints"));

        TableColumn<DriverResult, Integer> rankCol = new TableColumn<>("Rank");
        rankCol.setCellValueFactory(new PropertyValueFactory<>("rank"));

        tableView.getColumns().add(driverNameCol);
    ...
    private void updateTableView(int year) {
        data.clear();
        data.addAll(driverResultRepository.getResultByYear(year));
    }
